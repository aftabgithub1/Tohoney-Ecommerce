		...
		<div class="header-top bg-2">
			<div class="fluid-container">
              ...
              <li>
                ...
                @auth {{Auth::user()->name}} @else  My Account  @endauth<i class="fa fa-angle-down"></i></a>
				...
				<div class="row">
					...
					<div class="col-md-4 col-lg-2 col-sm-5 col-4">
						<ul class="search-cart-wrapper d-flex">
							...
							<li>
								@php
									$cart_count = App\Models\Cart::where('ip_address', request()->ip())->count();
								...
								<ul class="cart-wrap dropdown_style">
									@foreach($carts as $cart)
										<li class="cart-items">
											<div class="cart-img">
												<img src="{{asset('uploads/product/'.$cart->products->thumbnail)}}" width="60" alt="">
											</div>
											<div class="cart-content">
												<a href="cart.html">{{$cart->products->name}}</a>
												<span>QTY : {{$cart->quantity}}</span>
												<p>Tk. {{$cart->products->price}}</p>
												<a href="{{url('delete_cart_item/'.$cart->id)}}"><i class="fa fa-times"></i></a>
											</div>
										</li>
										@php
											$sub_total += $cart->quantity * $cart->products->price
										@endphp
									@endforeach
									<li>Subtotol: <span class="pull-right">Tk. {{$sub_total}}</span></li>
									<li>
										<a href="{{url('cart')}}"><button>Check Out</button></a>
									</li>
								</ul>
							</li>
						</ul>
