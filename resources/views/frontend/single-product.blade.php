...
@section('content')
	...
	<div class="single-product-area ptb-100">
		<div class="container">
			@if(session('add_to_cart_success'))
				<div class="alert alert-success text-success">
					<strong>Success ! </strong>{{session('add_to_cart_success')}}
				</div>
			@endif
			@if(session('add_to_cart_fail'))
				<div class="alert alert-danger text-danger">
					<strong>Sorry ! </strong>{{session('add_to_cart_fail')}}
				</div>
			@endif
			<div class="row">
				<div class="col-lg-6">
					<div class="product-single-img">
						<div class="product-active owl-carousel">
							<div class="item">
								<img src="{{asset('uploads/product/'.$product_details->thumbnail)}}" alt="">
							</div>
							@foreach($product_details->productMultipleImage as $multiple_image)
							<div class="item">
								<img src="{{asset('uploads/product/product_details/'.$multiple_image->image)}}" alt="">
							</div>
							@endforeach
						</div>
				...
				<div class="col-lg-6">
					<div class="product-single-content">
						...
						<ul class="input-style">
							<form action="{{route('add_to_cart', ['product_id' => $product_details->id])}}" method="post">
								@csrf
								<li class="quantity cart-plus-minus">
									@php
										$cart_exists = App\Models\Cart::where('ip_address', request()->ip())->where('product_id', $product_details->id)->exists();
										$cart = App\Models\Cart::where('ip_address', request()->ip())->where('product_id', $product_details->id)->first();
									@endphp
									<input type="text" name="quantity" value="{{$cart_exists ? $cart->quantity : 1}}" />
								</li>
								<li><a href=""><button type="submit" class="bg-transparent border-0 text-light">Add to Cart</button></a></li>
							</form>
						</ul>
						<ul class="cetagory">
							<li>Categories: </li>
				...
				<div class="col-lg-3 col-sm-6 col-12">
					<div class="featured-product-wrap">
						<div class="featured-product-img">
							<img src="{{asset('uploads/product/'.$related_product->thumbnail)}}" alt="">
						</div>
